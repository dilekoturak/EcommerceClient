...
const routes: Routes = [
  { 
    path: "admin", component: LayoutComponent , children: [
      ...
      { path: "product", loadChildren: () => import("./admin/components/product/product.module").then
  ...
  { path: "product", loadChildren : () => import("./ui/components/product/product.module").then
        ( module => module.ProductModule )},
